...
def p_effective_supply(params, substep, state_history, prev_state):    
    ...
    """
    temp = prev_state['floating_supply']['cusd'] - state_history[-1][-1]['floating_supply']['cusd']
    print(temp)
...
def p_market_price_impact(params, substep, state_history, prev_state):
    ...
    """
    prev_state['_market_price_generator'].valuate(prev_state['floating_supply'], prev_state['virtual_tanks']['usd'])
